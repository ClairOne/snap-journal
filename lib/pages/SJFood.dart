...
class _SJFoodState extends State<SJFood> {
  ...
  void submit() {
    ...
    if (this._formKey.currentState.validate()) {
      ...
      print(
          'SJStateBefore: ${_data.SJStateBefore}'); // thoughts or Feelings Before Eating
              ...
              children: <Widget>[
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .datetime, // @TODO SJWhen: use a date time picker
                    decoration: new InputDecoration(
                        hintText: 'YYYY-MM-DD H:i', labelText: 'When'),
                ...
                new TextFormField(
                    keyboardType:
                        TextInputType.text, // @TODO SJWhere: use geo location
                    decoration: new InputDecoration(
                        hintText: 'McDonald\'s', labelText: 'Where'),
                    // validator: this._validateEmail,
                    onSaved: (String value) {
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .multiline, // @TODO SJWhat: add inline tags
                    decoration: new InputDecoration(
                        hintText:
                            'e.g. 32oz Diet Coke, cheeseburger and large french fry',
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .text, // @TODO SJActivityBefore: use a lookahead
                    decoration: new InputDecoration(
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .number, // @TODO SJHungerLevelBefore: convert to 1-5 selector
                    decoration: new InputDecoration(
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .number, // @TODO SJHungerLevelAfter: convert to 1-5 selector
                    decoration: new InputDecoration(
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .number, // @TODO SJPace: convert to 1-5 selector
                    decoration: new InputDecoration(
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .text, // @TODO SJHow: look ahead on common emotions
                    decoration: new InputDecoration(
                ...
                new TextFormField(
                    keyboardType: TextInputType
                        .number, // @TODO SJOverallMood: convert to 1-5 selector
                    decoration: new InputDecoration(
